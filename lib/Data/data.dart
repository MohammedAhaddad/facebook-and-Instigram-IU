import 'package:flutter_application_1/FacebookModels/FacbookReaponde.dart';
...
List<PostResponse> post = data.map((e) => PostResponse.fromjson(e)).toList();
List<FaccbookPostResponse> Facbookpost =
    data.map((e) => FaccbookPostResponse.fromjson(e)).toList();
